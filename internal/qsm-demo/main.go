...
func main() {
	playerStateMachine := qsm2.Init[State]()

	playerStateMachine.SetMutationRuleNtoN([]State{idle, walk}, []State{idle, walk}, &qsm2.MutationRule{
		Before: func() {
	...
	playerStateMachine.SetMutationRule(idle, walk, &qsm2.MutationRule{
		Before: func() {
	...
	playerStateMachine.SetMutationRule(walk, idle, &qsm2.MutationRule{
		Before: func() {
