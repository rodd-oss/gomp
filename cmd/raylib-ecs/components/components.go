...
var TransformManager = ecs.CreateComponent[Transform](TRANSFORM_ID)
var HealthManager = ecs.CreateComponent[Health](HEALTH_ID)
var ColorManager = ecs.CreateComponent[color.RGBA](COLOR_ID)
