...
func (s *trSpriteController) Init(world *ecs.World)        {}
func (s *trSpriteController) FixedUpdate(world *ecs.World) {}
func (s *trSpriteController) Update(world *ecs.World) {
...
func (s *trSpriteController) Destroy(world *ecs.World) {}
